...
public class ViewModelBase : PropertyChangedBase
{
    ...
    public bool IsStoreActionsVisible
    {
        ...
        set => SetProperty(ref _isStoreActionsVisible, value, nameof(IsStoreActionsVisible), additionalProperties: nameof(StoreActionsVisibility));
    }
    ...
    /// </summary>
    public ICommand PopularProducts { get; }
    ...
    public ViewModelBase()
    {
        ...
        PopularProducts = new RelayCommand(OpenPopularProductDialogWindow);
    }
