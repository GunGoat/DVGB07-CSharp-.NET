...
public class StoreViewModel : ViewModelBase
{
    ...
    public async void CompletePurchase()
    {
        ...
        await SyncDownloadProducts();
        if (IsSyncWarningVisible)
        {
            MessageBox.Show("There was an issue synchronizing with online products. Please check your internet connection and try again.",
        ...
        {
            int updatedStock = cartItem.Product.Stock - cartItem.Quantity;
            cartItem.Product.Stock = updatedStock;
        }
        await SyncUploadProducts();
